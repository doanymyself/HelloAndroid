...
import com.pact.hello.view.CommonDialog;
...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void setContenierView(int showtabs) {
        ...
        home_tab1_cb.setText("首页");
        home_tab2_cb.setText("资讯");
        home_tab3_cb.setText("活动");
        home_tab4_cb.setText("社区");
        home_tab5_cb.setText("设置");
